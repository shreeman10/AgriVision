...
const ReportModal = ({ result, onClose }) => {
    ...
    const handleDownloadPDF = async () => {
        ...
        try {
            ...
            pdf.save(`AgriGuard_Report_${new Date().toISOString().split('T')[0]}.pdf`);
        } catch (error) {
            ...
            >
                ...
                <div ref={reportRef} className="p-8 bg-white">
                    <div className="flex justify-between items-start mb-8 border-b pb-6">
                        <div>
                            <h1 className="text-3xl font-extrabold text-gray-900 mb-2">AgriGuard</h1>
                    ...
                    <div className="mt-8 text-center text-xs text-gray-400 border-t pt-4">
                        <p>Generated by AgriGuard AI • {new Date().toLocaleString()}</p>
                    </div>
                </div>
